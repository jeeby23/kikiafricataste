        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-white rounded-2xl p-8 space-y-6">
              ...
              <p className="text-gray-600">
                You’ll receive a confirmation text and WhatsApp message when your order is ready for
                pickup.
              </p>
            ...
            <div className="bg-white rounded-2xl p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-y-8 text-sm">
                ...
                <div>
                  ...
                  <p className="text-gray-600">{PICKUP_LOCATION.address}</p>
                </div>
                <div>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl p-8 sticky top-6">
              ...
              <Link
                href="/products"
                className="mt-10 block w-full bg-black hover:bg-[#c9a96e] hover:text-black transition text-white text-center py-4 rounded-2xl font-bold tracking-widest uppercase"
              >
                CONTINUE SHOPPING
              </Link>
            </div>
