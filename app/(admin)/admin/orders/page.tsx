...
export default function OrdersPage() {
  ...
  const orders = useMemo(() => {
    ...
    switch (sort) {
      ...
      case 'highest': return copy.sort((a, b) => calcTotal(b.subtotal, b.deliveryFee) - calcTotal(a.subtotal, a.deliveryFee))
      case 'lowest':  return copy.sort((a, b) => calcTotal(a.subtotal, a.deliveryFee) - calcTotal(b.subtotal, b.deliveryFee))
      default:        return copy
    }
  }, [rawOrders, sort])
  ...
  if (isLoading) return <PageLoader title="Loading Orders..." description="Please wait while we fetch customer orders." />
          ...
          {orders.length === 0 ? (
            ...
            <div key={order.id} className="p-4 hover:bg-gray-50 transition-colors">
              ...
              <div className="flex justify-between items-center mb-3">
                ...
                <p className="text-sm font-semibold">{fmtPounds(calcTotal(order.subtotal, order.deliveryFee))}</p>
              </div>
              ...
              <tbody>
                {orders.length === 0 ? (
                  ...
                  <tr key={order.id} className="border-b last:border-0 hover:bg-gray-50 transition-colors">
                    ...
                    <td className="p-4 text-sm whitespace-nowrap">{fmtPounds(order.subtotal)}</td>
                    ...
                    {/* total: recomputed from subtotal (£) + deliveryFee/100 */}
